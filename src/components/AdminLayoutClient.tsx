...
import { 
  Activity, ShieldAlert, FolderKanban, Receipt, 
  Mail, LogOut, Menu, X, ChevronLeft, ChevronRight, Bell
} from "lucide-react";
...
const adminMenuItems = [
  ...
  { name: "Proyek Klien", href: "/admin/projects", icon: FolderKanban },
  { name: "Tagihan & Invoice", href: "/admin/invoices", icon: Receipt },
...
export default function AdminLayoutClient({ children, user }: AdminLayoutClientProps) {
  ...
  const NavLink = ({ item, onClick }: { item: typeof adminMenuItems[0]; onClick?: () => void }) => {
        ...
        <div style={{
          ...
          {sidebarOpen && (
            <span style={{ fontSize: "1.25rem", fontWeight: 800, color: "#0f172a" }}>
              ...
              <span className="text-[9px] font-extrabold uppercase px-1.5 py-0.5 rounded ml-1 bg-indigo-50 border border-indigo-200 text-indigo-600">ADMIN</span>
            </span>
          )}
        </div>
