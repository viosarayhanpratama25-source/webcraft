...
import { Lock, ShieldAlert, ArrowRight, Activity, CheckCircle2 } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 relative overflow-hidden px-4">
      ...
      <div className="w-full max-w-md z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm">Buat kata sandi baru untuk akun Anda</p>
        </div>
        ...
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 shadow-2xl">
          ...
          {success ? (
            <div className="text-center py-4">
              <div className="w-12 h-12 bg-green-500/10 border border-green-500/20 text-green-400 rounded-full flex items-center justify-center mx-auto mb-4 animate-bounce">
                <CheckCircle2 className="w-6 h-6" />
              </div>
              <h3 className="text-lg font-bold text-white mb-2">Kata Sandi Diperbarui!</h3>
              <p className="text-slate-400 text-sm mb-2 leading-relaxed">
                Kata sandi Anda telah berhasil diubah.
              </p>
              <p className="text-xs text-slate-500">Mengarahkan Anda ke halaman masuk...</p>
            </div>
          ) : (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3 bg-slate-950/50 border border-slate-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 rounded-2xl text-slate-100 placeholder-slate-600 focus:outline-none transition-all text-sm"
                  />
                </div>
              </div>
